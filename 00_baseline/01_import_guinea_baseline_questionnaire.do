...
*   TITLE    :    01 - IMPORTING THE DATA OF THE BASELINE
*                   ____________________________________________________________
*                   ØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØØ
*
********************************************************************************/
/*
name : import_guinea_baseline_questionnaire.do
...
*	Outputs: "guinea_baseline_questionnaire_imported.dta"
...
********************************************************************************
* chemins
local csvfile "$main/Data/raw/baseline/guinea_baseline_questionnaire.csv"
local dtafile "$main/Data/dta/guinea_baseline_questionnaire.dta"
local output "$main/Data/output/baseline/questionnaire_baseline_imported.dta"
...
local corrfile1 "$main/Data/correction_file/unfinished_questionnaire_1.xlsx" // Les questionnaires non-finalisÈs 1
local corrfile2 "$main/Data/correction_file/unfinished_questionnaire_2.xlsx" //Les questionnaires non-finalisÈs 2
local corrfile3 "$main/Data/correction_file/unfinished_questionnaire_3.xlsx" //Les questionnaires non-finalisÈs 3
local corrfile4 "$main/Data/correction_file/error_lycee_name.xlsx" //Les questionnaires avec de mauvais nom de lycÈes
...
*avoiding pb with string variable
...
replace `dtvarlist'2="2" if `dtvarlist'2=="f√©vr."
replace `dtvarlist'2="2" if `dtvarlist'2=="févr."
...
/////////////////////////////////////////////////////////////////////////
//////////////////    append paper questionnaire         ////////////////
/////////////////////////////////////////////////////////////////////////

local paper "$main/Data/raw/baseline/guinea_baseline_paper.xlsx"

import excel using "`paper'", firstrow clear

local datetime_fields1 "submissiondate starttime endtime"
	foreach dtvarlist in `datetime_fields1' {
split `dtvarlist' // split the variables into 4 sub-variables
* replace months into numbers 
replace `dtvarlist'2="10" if `dtvarlist'2=="oct."
replace `dtvarlist'2="11" if `dtvarlist'2=="nov."
...
append using "`paper'",force
save "$main/Data/output/baseline/questionnaire_baseline_imported.dta", replace
