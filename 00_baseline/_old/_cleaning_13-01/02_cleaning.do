...
*I have to call those students to understand in which lycée they are
*/
...
replace `x'="FRANCE" if `x'=="JE VOUDRAI HABITER EN FRANCE" | `x'=="MFRANCE" | `x'=="A   PARIS" | `x'=="SKANTE  PARIS" | `x'=="ENFRANCE"|`x'=="NANTES"|`x'=="LYON"| `x'=="FRENCE" | `x'=="FRANCE SAYON CAMARA" | `x'=="FRANCE  002245689" | `x'=="FANCE" |`x'=="SAINT Ã‰TIENNE" | `x'=="TOULOUSE" | `x'=="STRASBOURG" | `x'=="NANTE"| `x'=="MONACO"| `x'=="LION" | `x'=="LILLE" | `x'=="EN FANCE" | `x'=="ÃŽLE DE FRANCE"| `x'=="FRANCE ABACARCONDE" | `x'=="FRANCE 625241415" | `x'=="FRANC" | `x'=="A FRANCE" | `x'=="A FANCE" | `x'=="FRANÃ§E" | `x'=="ITALIE APRÃ¨S LA FRANCE" | `x'=="LE PARIE" | `x'=="FRANCS" | `x'=="IA FRANCE" |`x'=="LA FRANÃ§E" | `x'=="FRANÃ§AIS" | `x'=="A PARIS" | `x'=="EN FRANCE" | `x'=="FRANÃ§AIS"| `x'=="LA FRANCE" | `x'=="FRANCE " | `x'==" FRANCE " | `x'=="EN FRANCE, BANQUE" | `x'=="EN FRANCS" | `x'=="EN FRANÃ§E" | `x'=="PARI" | `x'=="PARIS" | `x'=="PARIE"

replace `x'="CANADA" if `x'=="M'ONT REAL" | `x'=="CANADAN" |`x'=="CANADAN"| `x'=="L'AMÃ©RIQUE PRÃ©CISÃ©MENT AU CANADA" | `x'=="CANADAT" | `x'=="AU CANADAT" | `x'=="EN AMÃ©RIQUE  (CANADA)" | `x'=="Ã€ CANADA" | `x'=="I'AMÃ©RIQUE PRÃ©CISÃ©MENT Ã  CANADA" | `x'=="A CANADA"| `x'=="AU CANADA" | `x'=="GANADA" | `x'=="AU CANADA " | `x'=="KANADA" | `x'=="LE CANADA" | `x'=="CANADA " | `x'==" CANADA " | `x'=="En AmÃ©rique  (Canada)" |`x'=="Ã? CANADA"

replace `x'="GERMANY" if `x'=="ALLEMAGNE 663241415" |`x'=="ALMAGNE" | `x'=="ALLÃ©MAGNE" | `x'=="ALLEMAN3" | `x'=="ALLEAGNE" | `x'=="EN ALLEMAGNE" | `x'=="ALLEMAGNE" | `x'=="ALLEMANGNE" | `x'==" L'ALLEMAGNE" | `x'=="L'ALLEMAGNE"

replace `x'="UNITED STATES" if `x'=="L'AMÃ‰RIQUE"|`x'=="U SA"| `x'=="AUX ETATS-UNIS"| `x'=="A PHILADELPHIA" | | `x'=="LES Ã‰TATS UNIS D'AMÃ©RIQUE" | `x'=="LES Ã‰TATS UNIS D'AMERIQUE" | `x'=="AUX Ã‰TATS-UNIS" | `x'=="NEW-YORK" | `x'=="U Ã©TAT UNIS" | `x'=="Ã‰TATS UNIS D'AMÃ©RIQUE" | `x'=="Ã‰TAT UNIS" | `x'=="Ã‰TATS-UNIS D'AMÃ©RIQUE" |`x'=="Ã‰TAT UNIS D'AMÃ©RIQUE" | `x'=="USA AMÃ©RIQUE" | `x'=="AU Ã‰TATS-UNIS" | `x'=="A LOS ANGELES" 

replace `x'="UNITED STATES" if `x'==" Ã‰TATS-UNIS  D'AMÃ©RIQUE" |`x'=="Ã‰TAT UNIS AMÃ©RIQUE" |`x'=="Ã‰TAT -UNIS" |`x'=="WASHINGTON" |`x'=="U,.S,A" | `x'=="CHICAGO"| `x'=="USA" |  `x'=="AU Ã©TAT UNIS" | `x'==" Ã‰TATS-UNIS" | `x'=="Ã‰TATS-UNIS" | `x'=="Ã‰TATS UNIS" | `x'==" Ã‰TATS UNIS D'AMÃ©RIQUE" | `x'=="Ã‰TAS UNIS D'AMÃ©RIQUE"| `x'=="Ã‰TAT  UNIS D AMÃ©RIQUE" | `x'=="Ã‰TAT UNIS D'AMÃ‰RIQUE" | `x'==" Ã‰TAT UNIS" | `x'=="Ã‰TAS UNIS" | `x'=="LES USA" | `x'=="U S A" 
...
replace `x'="EQUATORIAL GUINEA" if `x'=="GUINÃ©E EQUATORIAL" | `x'=="GUINEE EQUATORIALE"
...
replace `x'="AMERICA" if `x'=="ETAT UNIE"| `x'=="AMÃ©RICAIN"| `x'=="AMÃ©RIQUES" | `x'=="AMERQUE" | `x'=="AMERICAINE" | `x'=="AMERIQUE" | `x'=="LA L'AMÃ©RIQUE" |`x'=="L'AMÃ©RIQUE" | `x'=="AMERIC" | `x'=="EN AMERIQUE" | `x'=="AMERIQEU"| `x'=="AMÃ©RIQUE" | `x'==" EN AMERIQUE" | `x'=="EN AMÃ©RIQUE" | `x'=="L' AMERIQUE"| `x'=="L' AMÃ©RIQUE"| `x'=="L'AMERIQUE"| `x'==" L'AMÃ©RIQUE"
...
replace `x'="GUINEA CONAKRY" if `x'=="LE GUINÃ©E" |`x'=="LA GUINÃ‰E" | `x'=="FRIA"| `x'=="COONAKRRY" |`x'=="CNAKRY" | `x'=="CANAKRY" | `x'=="MAMOU" | `x'=="KANKAN" | `x'=="Ã€ CONACKRY"| `x'=="LA GUINÃ¨E"| `x'=="LA GUINNEE"| `x'=="IL GUINE"| `x'=="IA GUINÃ©E" | `x'=="GUINÃ©E CONAKRY"| `x'=="GUINNEE" | `x'=="GUINNE" | `x'=="GUINEEE" | `x'=="GUINEA" | `x'=="EN GUINNEE" | `x'=="EN GUINEE"| `x'=="CONACKRY"| `x'=="CON1KRY"| `x'=="COKNARY"| `x'=="A CONAKRY"|`x'=="GUINEE"| `x'=="CONAKRY" | `x'=="A' CONAKRG" | `x'=="SANGOYAH" | `x'=="A CONAKRG" | `x'=="EN GUINÃ©E" | `x'=="GUINÃ©E" | `x'=="GUINÃ©E  CONAKRY" |  `x'=="LA GUINÃ©E"

replace `x'="IVORY COAST" if `x'=="CÃ´TÃ© D 'IVOIRE" |`x'=="COTE D'IVOIRE" |`x'=="ABIDJAN" | `x'=="IVOIRE"| `x'=="CÃ´TÃ© DIVOIRE" | `x'=="CÃ´TÃ© D'IVOIRE" | `x'=="CÃ´TÃ© D'IVOIR" | `x'=="COTE D IVOR" | `x'=="CÃ´TE DIVOIR" | `x'=="CÃ´TE D'IVOIRE" | `x'==" CÃ´TE DIVOIR"

replace `x'="UNITED KINGDOM" if `x'=="ROYAUM UNI" | `x'=="ROYAUME-UNI"

replace `x'="EGYPT" if  `x'=="EN Ã‰GYPTE" | `x'=="Ã‰GYPTE" | `x'=="EGYPE" | `x'=="EJIPT" | `x'=="EGYPTE"

replace `x'="BRAZIL" if `x'=="BRÃ¨SIL"| `x'=="BRESIL"| `x'=="BRÃ©SIL" | `x'=="AU BRAZIL"

replace `x'="GREECE" if `x'=="GRECEE" |  `x'=="GRECE" | `x'=="GRÃ¨CE"

replace `x'="QATAR" if `x'=="KATAR" | `x'=="QUATAR"

replace `x'="ALGERIA" if `x'=="ALGER"| `x'=="ALGÃ©RIE" | `x'=="ALGERI"

replace `x'="DUBAI" if `x'=="DUBAÃ¯" | `x'=="DOUBAI" | `x'=="DOUBAYE"
...
replace `x'="SIERRA LEONE" if  `x'=="SERRA LÃ©ONE" | `x'=="SIERRA LEONNE"| `x'=="LA SIERRA LÃ©ONE"
...
replace `x'="SENEGAL" if `x'=="SEGALE" | `x'=="SÃ©NÃ©GAL  00221 77 918 45" | `x'=="SÃ©NÃ©GAL"|`x'=="SEGAL" | `x'=="SENEGALE" | `x'=="DAKAR"

replace `x'="TUNISIA" if `x'=="TUNISIE"

replace `x'="THAILAND" if `x'=="TAILAND"

replace `x'="GUINEA BISSAU" if `x'=="GUINÃ©E BISSAU" | `x'=="BISSAU"
...
replace `x'="SOUTH KOREA" if `x'=="CORÃ©E  DU SUD"| `x'=="CORRÃ© DU SUD" | `x'=="CORÃ© DU SUD"
}
