...
drop _merge
merge m:1 schoolid using "$main/definitive\dta\size3_wealth2_1000_treatment.dta"
...
orth_out age gender pular_language sousou_language malinke_language wealth_index outside_contact_no mig_classmates
 ...
 die_boat die_bef_boat planning prepare mig_desire using "$main/bc_var_indiv_size3_wealth2_1000_treatment.xls", by(_assignment) 
