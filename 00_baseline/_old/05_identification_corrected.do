...
use "$main/output\baseline\identification.dta", clear
...
save "$main/output/baseline/identification3.dta", replace
...
modifications that we've jsut done. I replace the initial dataset by that one.
