...
drop time* unique_draws upper_bound num_draws random* scaled* note*
...
*students because 2 remplaÁant came instead of one.Sekouma Kourouma was the last
*remplacant according to the list.
		drop if key=="uuid:daf05498-1cf8-4e2a-9302-3e12e3802edd"

*in KOFI ANNAN, I had to inform the students + remplaÁants before the day before the survey
*in the end, we got 52 participants because there were more remplacants than missing students.
*So I delete the last two remplaÁants 
...
*error in lycee name corrected thanks to the sensibilisation
replace lycee_name="ABDOUL MAZID DIABY" if key=="uuid:cf8a4a12-196a-4107-9b50-e433ca98ca9c"
replace lycee_name="HAMAS" if key=="uuid:522d727d-65f9-4040-bf8d-7fb1b44cc92d"
...
label define language 1 "Sousou" 2 "MalinkÈ" 3 "Pular" 4 "Kpele" 5 "Kissi" 6 "Loma" 7 "Baga" 8 "Coniagui" 9 "Other Guinean language" 10 "Other language" 11 "I speak French only"
...
label variable sec1_12 "Has he ever attended school ?"
note sec1_12 : "Has he ever attended school ?"
label values sec1_12 yes_no


label variable sec1_13 "What is the highest level of education he completed ?"
note sec1_13 : "What is the highest level of education he completed ?"
*incorportating "no formal education" in the level of education"
replace sec1_13=999 if sec1_12==2
...
label define toilet  1	"Douche avec pot ‡ la maison" 2	"Douche avec pot dans la latrine" 3	"Douche avec pot dans le WC" 4	"Fosse díaisance sans dalle/trou ouvert ‡ la maison" 5	"Fosse díaisance sans dalle/trou ouvert dans la latrine" 6	"Fosse díaisance sans dalle/trou ouvert dans le WC" 7	"No facility, Bush, Field, Beach"
...
replace `x'="" if `x'=="UUU" |`x'=="THIERNO MARINA SOW" |`x'=="SEIRALEON" |`x'=="SDIMA" |`x'=="SANKOUMBA" |`x'=="SANA" |`x'=="S SANTIGUI TOURE" |`x'=="ROI" |`x'=="NDEYE DIALLO" |`x'=="MOUSSA" |`x'=="HAFIA" |`x'=="GAJA" |`x'=="FODE MOUSSA BERETE" |`x'=="EN" |`x'=="CONA" |`x'=="CHEICK" |`x'=="BOUBA" | `x'=="BOH SARAN" |`x'=="BALDE" |`x'=="BADEMBA" |`x'=="YOUNONSSA" |`x'=="YARIE" |`x'=="TY" |`x'=="THIERNO BAH" |`x'=="TONTON PAPA" |`x'=="TAMBOUR MORY KAMANO" |`x'=="TAIBOU BAH" |`x'=="S√®" |`x'=="SYLLA" |`x'=="SOS" |`x'=="SILLO KAMONO" |`x'=="SIGURI" |`x'=="SIDIKI" |`x'=="SA√ØDOU" |`x'=="SARAH TOURE" | `x'=="SANNY CAMARA OU VERRETY" | `x'=="SALIOU"
replace `x'="" if `x'=="MARIAME" |`x'=="MAMADOU LAMINE DIALLO" | `x'=="MAMADOU LAMARANA" |`x'=="KORKA" |`x'=="KALIL CAMARA" |`x'=="KADIZA" |`x'=="JOAO MIGUEL" |`x'=="AIMé SIDIBE" |  `x'=="SABANA" | `x'=="PAR" |`x'=="PAPA" |`x'=="OUSMANE KEITA" | `x'=="OUSMANE" | `x'=="N'ZEREKORE" | `x'=="N'ASSURE BERETE" | `x'=="MOUSTAPHA" |`x'=="MOHAMED SANOUSSI CAMARA" |`x'=="MOHAMED CONDE" |`x'=="MILéN" |`x'=="MARIE LOUISE CAMARA" |`x'=="MARIE" |`x'=="MARIE" |`x'=="MARIAMA" |`x'=="MARCEILLE" |`x'=="MAMAN" |`x'=="MAMADOU SOW" |`x'=="MAMADOU DIAN" |`x'=="MAMADOU" |`x'=="MAMADI" |`x'=="MAMADAMA" | `x'=="MADOU TOURE"
replace `x'="" if `x'=="MAROMAC" | `x'=="BEN" |`x'=="MA BOSSOIR CAMARA" | `x'=="LIMA KEITA" | `x'=="LERO" |`x'=="KONGUEL" | `x'=="KANABA" | `x'=="KALOU" |`x'=="JOSé DA GAMA" | `x'=="INTERNET" |`x'=="IBRAHIMA KENNEDY BAH" |`x'=="IBRAHIMA DIALLO" | `x'=="IBRAHIMA CAMARA" |`x'=="HABIB BALDE" | `x'=="GOMBO" |`x'=="FODé SYLLA" |`x'=="FATOUMATA MANSARE" | `x'=="GGUI" |`x'=="FANTA" |`x'=="EN GUINéE 625812444" |`x'=="DéDé" |  `x'=="DJEDA" |`x'=="DJADA" |`x'=="DABY" |`x'=="CONTé" |`x'=="CONCON" |`x'=="CISSé" |`x'=="CON" |`x'=="CAMARA" |`x'=="BECKAYE NIANE" | `x'=="BARRY" | `x'=="BANKOKE" | `x'=="BANJUL" |`x'=="BAH" | `x'=="A√ØCHA" | `x'=="ANYER"
...
replace `x'="FRANCE" if `x'=="√Ä PARIS" |`x'=="MARSEILLE" |`x'=="AVRE" |`x'=="LE HAVRE" | `x'=="FRANCE  LION" | `x'=="FRACNCE" |`x'=="ANGER" | `x'=="JE VOUDRAI HABITER EN FRANCE" | `x'=="MFRANCE" | `x'=="A   PARIS" | `x'=="SKANTE  PARIS" | `x'=="ENFRANCE"|`x'=="NANTES"|`x'=="LYON"| `x'=="FRENCE" | `x'=="FRANCE SAYON CAMARA" | `x'=="FRANCE  002245689" | `x'=="FANCE" |`x'=="SAINT √âTIENNE" | `x'=="TOULOUSE" | `x'=="STRASBOURG" | `x'=="NANTE"| `x'=="MONACO"| `x'=="LION" | `x'=="LILLE" | `x'=="EN FANCE" | `x'=="√éLE DE FRANCE"| `x'=="FRANCE ABACARCONDE" | `x'=="FRANCE 625241415" | `x'=="FRANC" | `x'=="A FRANCE"
replace `x'="FRANCE " if  `x'=="A FANCE" | `x'=="FRAN√ßE" | `x'=="ITALIE APR√®S LA FRANCE" | `x'=="LE PARIE" | `x'=="FRANCS" | `x'=="IA FRANCE" |`x'=="LA FRAN√ßE" | `x'=="FRAN√ßAIS" | `x'=="A PARIS" | `x'=="EN FRANCE" | `x'=="FRAN√ßAIS"| `x'=="LA FRANCE" | `x'=="FRANCE " | `x'==" FRANCE " | `x'=="EN FRANCE, BANQUE" | `x'=="EN FRANCS" | `x'=="EN FRAN√ßE" | `x'=="PARI" | `x'=="PARIS" | `x'=="PARIE"

replace `x'="CANADA" if `x'=="AUCANADA" | `x'=="M'ONT REAL" | `x'=="CANADAN" |`x'=="CANADAN"| `x'=="L'AMéRIQUE PRéCISéMENT AU CANADA" | `x'=="CANADAT" | `x'=="AU CANADAT" | `x'=="EN AMéRIQUE  (CANADA)" | `x'=="√Ä CANADA" | `x'=="I'AMéRIQUE PRéCISéMENT √† CANADA" | `x'=="A CANADA"| `x'=="AU CANADA" | `x'=="GANADA" | `x'=="AU CANADA " | `x'=="KANADA" | `x'=="LE CANADA" | `x'=="CANADA " | `x'==" CANADA " | `x'=="En Amérique  (Canada)" |`x'=="√? CANADA"

replace `x'="GERMANY" if `x'=="ALLEMANG" |`x'=="ALLEMANE" |`x'=="ALMANGNE" | `x'=="ALLEMAGNE 663241415" |`x'=="ALMAGNE" | `x'=="ALLéMAGNE" | `x'=="ALLEMAN3" | `x'=="ALLEAGNE" | `x'=="EN ALLEMAGNE" | `x'=="ALLEMAGNE" | `x'=="ALLEMANGNE" | `x'==" L'ALLEMAGNE" | `x'=="L'ALLEMAGNE"
/*line10*/
replace `x'="UNITED STATES" if `x'=="AMéRIQUE  (NEW YORK )" | `x'=="MON PAYS DE R√™VE C'EST L'AMéRIQUE" |`x'=="√âTATS-UNIS  D'AMéRIQUE" |`x'=="L'AM√âRIQUE"|`x'=="U SA"| `x'=="AUX ETATS-UNIS"| `x'=="A PHILADELPHIA" | | `x'=="LES √âTATS UNIS D'AMéRIQUE" | `x'=="LES √âTATS UNIS D'AMERIQUE" | `x'=="AUX √âTATS-UNIS" | `x'=="NEW-YORK" | `x'=="U éTAT UNIS" | `x'=="√âTATS UNIS D'AMéRIQUE" | `x'=="√âTAT UNIS" | `x'=="√âTATS-UNIS D'AMéRIQUE" |`x'=="√âTAT UNIS D'AMéRIQUE" | `x'=="USA AMéRIQUE" | `x'=="AU √âTATS-UNIS" | `x'=="A LOS ANGELES" 

replace `x'="UNITED STATES" if `x'=="√âTATS-UNIS D'AMéRIQUE, " | `x'=="PENTAGONE" |`x'=="AUX √âTATS-UNIS D'AMéRIQUE" | `x'=="√âTATUNIS" |`x'=="CALIFORNIE" |`x'=="AMRIQUE" |`x'=="AMERICA" |`x'=="√âTAS UNI D'AMéRIQUE" |`x'==" √âTATS-UNIS  D'AMéRIQUE" |`x'=="√âTAT UNIS AMéRIQUE" |`x'=="√âTAT -UNIS" |`x'=="WASHINGTON" |`x'=="U,.S,A" | `x'=="CHICAGO"| `x'=="USA" |  `x'=="AU éTAT UNIS" | `x'==" √âTATS-UNIS" | `x'=="√âTATS-UNIS" | `x'=="√âTATS UNIS" | `x'==" √âTATS UNIS D'AMéRIQUE" | `x'=="√âTAS UNIS D'AMéRIQUE"| `x'=="√âTAT  UNIS D AMéRIQUE" | `x'=="√âTAT UNIS D'AM√âRIQUE" | `x'==" √âTAT UNIS" | `x'=="√âTAS UNIS" | `x'=="LES USA" | `x'=="U S A" 
...
replace `x'="UNITED STATES" if `x'=="ETAS UNIS AMERIQUE"| `x'=="LESUSA"| `x'=="ETAT UNIE"| `x'=="AMéRICAIN"| `x'=="AMéRIQUES" | `x'=="AMERQUE" | `x'=="AMERICAINE" | `x'=="AMERIQUE" | `x'=="LA L'AMéRIQUE" |`x'=="L'AMéRIQUE" | `x'=="AMERIC" | `x'=="EN AMERIQUE" | `x'=="AMERIQEU"| `x'=="AMéRIQUE" | `x'==" EN AMERIQUE" | `x'=="EN AMéRIQUE" | `x'=="L' AMERIQUE"| `x'=="L' AMéRIQUE"| `x'=="L'AMERIQUE"| `x'==" L'AMéRIQUE"
...
replace `x'="EUROPE" if `x'=="EN EUROPE" | `x'=="√Ä L'EUROPE" | `x'=="L'EUROPE" | `x'=="L√? L'EUROPE" | `x'=="IEUROPE" | `x'=="EROPE"
...
replace `x'="" if `x'=="MATOTO"  |`x'=="LA GUINéE CONAKRY"  |`x'=="LANSANAYAH"  |`x'=="LA GUINéE  CONAKRY"  | `x'=="IL VIT EN GUINéE"  | `x'=="GUIN√âE"  |`x'=="LE GUINéE" |`x'=="LA GUIN√âE" | `x'=="FRIA"| `x'=="COONAKRRY" |`x'=="CNAKRY" | `x'=="CANAKRY" | `x'=="MAMOU" | `x'=="KANKAN" | `x'=="√Ä CONACKRY"| `x'=="LA GUIN√®E"| `x'=="LA GUINNEE"| `x'=="IL GUINE"| `x'=="IA GUINéE" | `x'=="GUINéE CONAKRY"| `x'=="GUINNEE" | `x'=="GUINNE" | `x'=="GUINEEE" | `x'=="GUINEA" | `x'=="EN GUINNEE" | `x'=="EN GUINEE"| `x'=="CONACKRY"| `x'=="CON1KRY"| `x'=="COKNARY"| `x'=="A CONAKRY"|`x'=="GUINEE"| `x'=="CONAKRY" | `x'=="A' CONAKRG" | `x'=="SANGOYAH" | `x'=="A CONAKRG" | `x'=="EN GUINéE" | `x'=="GUINéE" | `x'=="GUINéE  CONAKRY" |  `x'=="LA GUINéE"
...
replace `x'="IVORY COAST" if `x'=="EN C√¥TE IVOIRE" |`x'=="C√¥TE-D'IVOIRE" |`x'=="C√¥TE D'IVOIR" | `x'=="C√¥TE DIVOIRE" | `x'=="C√¥Té D IVOIRE" | `x'=="C√¥Té IVOIRE"

replace `x'="UNITED KINGDOM" if `x'=="ROYAUM UNI" | `x'=="ROYAUME-UNI"
*line 30
replace `x'="EGYPT" if `x'=="EN √âGYPTE" | `x'=="√âGYPTE" | `x'=="EGYPE" | `x'=="EJIPT" | `x'=="EGYPTE"

replace `x'="BRAZIL" if `x'=="BRASIL" |`x'=="BR√®SIL"| `x'=="BRESIL"| `x'=="BRéSIL" | `x'=="AU BRAZIL"

replace `x'="GREECE" if `x'=="GRECEE" |  `x'=="GRECE" | `x'=="GR√®CE"
...
replace `x'="SIERRA LEONE" if `x'=="SIERRA  LéON" |`x'=="SIERRA-LEONNE" |`x'=="SIERRA LéON" | `x'=="SERRA LéONE" | `x'=="SIERRA LEONNE"| `x'=="LA SIERRA LéONE"
...
replace `x'="SWITZERLAND" if `x'=="SUISSE" | `x'=="LA SUISSE" | `x'=="SUSSE"  | `x'=="GEN√®VE" 

replace `x'="SENEGAL" if `x'=="SENGAL" |`x'=="SENEGAL 624341513" | `x'=="SéNEGALE" |`x'=="SéNEGAL" | `x'=="AU SéNéGAL" | `x'=="SEGALE" | `x'=="SéNéGAL  00221 77 918 45" | `x'=="SéNéGAL"|`x'=="SEGAL" | `x'=="SENEGALE" | `x'=="DAKAR"

replace `x'="TUNISIA" if `x'=="TUNISIE"

replace `x'="THAILAND" if `x'=="TAILAND" | `x'=="TAILLAND"

replace `x'="GUINEA BISSAU" if `x'=="GUINEE-BISSAU" |`x'=="GUINéE-BISSAU" | `x'=="GUINéE BISSAU" | `x'=="BISSAU"

replace `x'="NORWAY" if `x'=="NORV√®GE" | `x'=="NORVEGE"
...
replace `x'="SOUTH KOREA" if `x'=="CORéE"| `x'=="CORéE  DU SUD"| `x'=="CORRé DU SUD" | `x'=="CORé DU SUD"
...
replace sec0_q32="8" if sec0_q32=="ao√ªt"
...
replace `x'= subinstr(`x',"√Ø","Ô",.)
replace `x'= subinstr(`x',"é","È",.)
replace `x'= subinstr(`x',"√ß","Á",.)
replace `x'= subinstr(`x',"√∂","ˆ",.)
replace `x'= subinstr(`x',"√â","È",.)
replace `x'= subinstr(`x',"√®","È",.)
replace `x'= subinstr(`x',"√´","Î",.)
}
...
replace sec2_q92="2" if sec2_q92=="f√©vr."
...
replace sec2_q92="12" if sec2_q92=="d√©c."
replace sec2_q92="2" if sec2_q92=="déc."
