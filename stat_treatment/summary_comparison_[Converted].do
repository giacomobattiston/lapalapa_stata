...
//computing real wage//
	merge m:1 sec3_21 using "/Users/giacomobattiston/Dropbox/Lapa-Lapa/LuciaElianaGiacomo/Data/price_levels/price_ratios_cs.dta"
	drop _merge
...
merge m:1 country_string using "Users/giacomobattiston/Dropbox/Lapa-Lapa/LuciaElianaGiacomo/Data/price_levels/consumption_price_cs.dta"
...
*duration in months winsorized 99
gen it_duration_win95 = italy_duration
replace it_duration_win95 = . if it_duration_win95 == 99
replace it_duration_win95 = . if it_duration_win95 == 999
replace it_duration_win95 = . if it_duration_win95 == 99999
replace it_duration_win95 = . if it_duration_win95 < 0
qui sum it_duration_win95, detail
replace it_duration_win95=`r(p95)' if it_duration_win95 >`r(p95)' & it_duration_win95!=.
replace it_duration_win95=`r(p5)' if it_duration_win95 <`r(p5)' & it_duration_win95!=.
...
qui reg it_duration_win95 planning
mata: b  = st_matrix("e(b)")
mata: MA_TABLE[1, 6] =b[1,1]


qui qreg it_duration_win95 planning, quantile(.25)
mata: b  = st_matrix("e(b)")
mata: MA_TABLE[1, 7] =b[1,1]

qui qreg it_duration_win95 planning, quantile(.5)
mata: b  = st_matrix("e(b)")
mata: MA_TABLE[1, 8] =b[1,1]

qui qreg it_duration_win95 planning, quantile(.75)
mata: b  = st_matrix("e(b)")
...
*citizen 
local l 35
qui sum sec3_36 if sec3_36 != 999, detail
mata: MA_TABLE[`l', 1] = `r(mean)'
mata: MA_TABLE[`l', 2] = `r(p25)'
mata: MA_TABLE[`l', 3] = `r(p50)'
mata: MA_TABLE[`l', 4] = `r(p75)'
...
qui reg sec3_36 planning  if sec3_36 != 999
mata: b  = st_matrix("e(b)")
mata: MA_TABLE[`l', 6] =b[1,1]

qui qreg sec3_36 planning  if sec3_36 != 999, quantile(.25)
mata: b  = st_matrix("e(b)")
mata: MA_TABLE[`l', 7] =b[1,1]

qui qreg sec3_36 planning  if sec3_36 != 999, quantile(.5)
mata: b  = st_matrix("e(b)")
mata: MA_TABLE[`l', 8] =b[1,1]

qui qreg sec3_36 planning  if sec3_36 != 999, quantile(.75)
mata: b  = st_matrix("e(b)")
mata: MA_TABLE[`l', 9] =b[1,1]
...
reg sec3_41 planning if sec3_41 >= 0 & sec3_41<= 100
mata: b  = st_matrix("e(b)")
mata: MA_TABLE[`l', 6] =b[1,1]
