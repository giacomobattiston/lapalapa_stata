...
drop migration_conakry*
gen migration_conakry=.

replace migration_conakry=0 if surveycto_lycee==1

*Did you leave Conakry? NO
replace migration_conakry=0 if where_9_p==1 & missing(migration_conakry)
*Did you leave Conakry? YES
replace migration_conakry=1 if where_9_p==2 & missing(migration_conakry)
gen migration_conakry_1 = migration_conakry
st
*Did you leave Conakry? NO
replace migration_conakry=0 if where_9_contact_sec==1  & missing(migration_conakry)
*Did you leave Conakry? YES
replace migration_conakry=1 if where_9_contact_sec==2  & missing(migration_conakry)
*Did you leave Conakry? NO
...
gen migration_conakry_2 = migration_conakry
*Did you leave Conakry? YES
...
*Did you leave Conakry? YES
replace migration_conakry=1 if left_conakry_3_sss==1  & missing(migration_conakry)
*Did you leave Conakry? NO
replace migration_conakry=0 if left_conakry_3_sss==0  & missing(migration_conakry)
gen migration_conakry_3 = migration_conakry
*Did you leave Conakry? YES
replace migration_conakry=1 if left_conakry_sss==1 & info_source_sss == 3 & missing(migration_conakry)
*Did you leave Conakry? NO
replace migration_conakry=0 if left_conakry_sss==0  & info_source_sss == 3 &   missing(migration_conakry)
gen migration_conakry_4 = migration_conakry
*Did you leave Conakry? YES
...
gen migration_conakry_5 = migration_conakry

global mig_conkary_names = `" "Would like to migrate" "' ///
				+ `" "Plans to migrate" "' ///
				+ `" "Prepares to migrate" "'
				
global mig_conkary_table_legend = `" "(1) is outcome \emph{wishing to migrate}, (2) is \emph{planning to migrate}, (3)" "' ///
...
esttab using ///
"migrationconakry_fu2.tex", replace stats(cont N, label( "$2^{nd}$ Follow-up Cont. Mean" "N")) ///
...
nonumbers title(Migration from Conakry at $2^{nd}$ Follow-Up  \label{migrationconakryfu2}) /// 
mtitles("\shortstack{(1) \\ Only \\ Interviewed \\ Subject  }" ///
	"\shortstack{(2) \\  Previous \\ and \\ Contacts  }" ///
	"\shortstack{(3) \\  Previous \\ and \\ Class.  }" ///
	"\shortstack{(4) \\  Previous \\ and \\ Admin.  }" ///
	"\shortstack{(5) \\  Previous \\ and \\ Oth. Cont.  }") nobaselevels ///
addnotes($migration_conakry_table_legend)
...
gen migration_conakry_1 = migration_conakry
*Did you leave Conakry? NO
replace migration_conakry=0 if where_9_contact_sec==1 & ///
	(sec0_q1_contact_sec_p==1  | sec0_q1_contact_sec_p==2  | ///
	sec0_q1_contact_sec_p==3  | sec0_q1_contact_sec_p==4 | ///
	sec0_q1_contact_sec_p==5) & missing(migration_conakry)
*Did you leave Conakry? YES
replace migration_conakry=1 if where_9_contact_sec==2 & ///
	(sec0_q1_contact_sec_p==1  | sec0_q1_contact_sec_p==2 ///
	| sec0_q1_contact_sec_p==3  | sec0_q1_contact_sec_p==4 ///
	| sec0_q1_contact_sec_p==5) & missing(migration_conakry)
*Did you leave Conakry? NO
replace migration_conakry=0 if where_9_contact_p==1 & ///
	(sec0_q1_contact_p==1  | sec0_q1_contact_p==2 ///
	| sec0_q1_contact_p==3  | sec0_q1_contact_p==4 ///
	| sec0_q1_contact_p==5)  & missing(migration_conakry)
*Did you leave Conakry? YES
replace migration_conakry=1 if where_9_contact_p==2 & ///
	(sec0_q1_contact_p==1  | sec0_q1_contact_p==2  ///
	| sec0_q1_contact_p==3  | sec0_q1_contact_p==4 ///
	| sec0_q1_contact_p==5) & missing(migration_conakry)
gen migration_conakry_2 = migration_conakry
...
esttab using ///
"migrationconakry_less6_fu2.tex", replace stats(cont N, label( "$2^{nd}$ Follow-up Cont. Mean" "N")) ///
coeflabels(1.treatment_status "Control" 2.treatment_status ///
"Risk Treatment" 3.treatment_status "Econ Treatment" ///
4.treatment_status "Double Treatment" 2.strata "Big school" ///
 _cons "Constant") se ///
 starlevels(\sym{+} 0.1 \sym{*} 0.05 \sym{**} 0.01 \sym{***} 0.001) ///
nonumbers title(Migration from Conakry  at $2^{nd}$ Follow-Up  (Only Contacts with Last Conv. $<$ 6 Months Ago) \label{migrationconakryless6fu2}) /// 
mtitles("\shortstack{(1) \\ Only \\ Interviewed \\ Subject  }" ///
	"\shortstack{(2) \\  Previous \\ and \\ Contacts  }" ///
	"\shortstack{(3) \\  Previous \\ and \\ Class.  }" ///
	"\shortstack{(4) \\  Previous \\ and \\ Admin.  }" ///
...
esttab using ///
"migrationconakry_less1_fu2.tex", replace stats(cont N, label( "$2^{nd}$ Follow-up Cont. Mean" "N")) ///
coeflabels(1.treatment_status "Control" 2.treatment_status ///
"Risk Treatment" 3.treatment_status "Econ Treatment" ///
4.treatment_status "Double Treatment" 2.strata "Big school" ///
 _cons "Constant") se ///
 starlevels(\sym{+} 0.1 \sym{*} 0.05 \sym{**} 0.01 \sym{***} 0.001) ///
nonumbers title(Migration from Conakry  at $2^{nd}$ Follow-Up  (Only Contacts with Last Conv. $<$ 1 Month Ago)  \label{migrationconakryless1fu2}) /// 
mtitles("\shortstack{(1) \\ Only \\ Interviewed \\ Subject  }" ///
	"\shortstack{(2) \\  Previous \\ and \\ Contacts  }" ///
	"\shortstack{(3) \\  Previous \\ and \\ Class.  }" ///
	"\shortstack{(4) \\  Previous \\ and \\ Admin.  }" ///
...
drop migration_guinea*
*Notice that migration_conakry_1 is the same for all formulations above.
gen migration_guinea=.
replace migration_guinea=0 if migration_conakry_1==0
...
gen migration_guinea_1 = migration_guinea
*Did you leave Conakry? NO
replace migration_guinea=0 if where_11_contact_sec==1  & missing(migration_guinea)
*Did you leave Conakry? YES
replace migration_guinea=1 if where_11_contact_sec==2  & missing(migration_guinea)
*Did you leave Conakry? NO
...
gen migration_guinea_2 = migration_guinea
*Did you leave Conakry? YES
...
*Did you leave Conakry? YES
replace migration_guinea=1 if left_guinea_3_sss==1  & missing(migration_guinea)
*Did you leave Conakry? NO
replace migration_guinea=0 if left_guinea_3_sss==0  & missing(migration_guinea)
gen migration_guinea_3 = migration_guinea
*Did you leave Conakry? YES
replace migration_guinea=1 if left_guinea_sss==1 & info_source_sss == 3 & missing(migration_guinea)
*Did you leave Conakry? NO
replace migration_conakry=0 if left_conakry_sss==0  & info_source_sss == 3 &   missing(migration_guinea)
gen migration_guinea_4 = migration_guinea
*Did you leave Conakry? YES
...
gen migration_guinea_5 = migration_guinea

global mig_conkary_names = `" "Would like to migrate" "' ///
				+ `" "Plans to migrate" "' ///
				+ `" "Prepares to migrate" "'
				
global migration_guinea_table_legend = `" "(1) is outcome \emph{wishing to migrate}, (2) is \emph{planning to migrate}, (3)" "' ///
	+ `" "is \emph{preparing}. Errors are clustered at school level." "'
...
esttab using ///
"migrationguinea_fu2.tex", replace stats(cont N, label( "$2^{nd}$ Follow-up Cont. Mean" "N")) ///
coeflabels(1.treatment_status "Control" 2.treatment_status ///
"Risk Treatment" 3.treatment_status "Econ Treatment" ///
4.treatment_status "Double Treatment" 2.strata "Big school" ///
 _cons "Constant") se ///
...
mtitles("\shortstack{(1) \\ Only \\ Interviewed \\ Subject  }" ///
	...
	"\shortstack{(4) \\  Previous \\ and \\ Admin.  }" ///
	"\shortstack{(5) \\  Previous \\ and \\ Oth. Cont.  }") nobaselevels ///
addnotes($migration_guinea_table_legend)
...
gen migration_guinea_1 = migration_guinea
*Did you leave Conakry? NO
replace migration_guinea=0 if where_11_contact_sec==1  & ///
	(sec0_q1_contact_sec_p==1  | sec0_q1_contact_sec_p==2 ///
	| sec0_q1_contact_sec_p==3  | sec0_q1_contact_sec_p==4 ///
	| sec0_q1_contact_sec_p==5) &  missing(migration_guinea)
*Did you leave Conakry? YES
replace migration_guinea=1 if where_11_contact_sec==2  & ///
	(sec0_q1_contact_sec_p==1  | sec0_q1_contact_sec_p==2 ///
	| sec0_q1_contact_sec_p==3  | sec0_q1_contact_sec_p==4 ///
	| sec0_q1_contact_sec_p==5) &  missing(migration_guinea)
*Did you leave Conakry? NO
replace migration_guinea=0 if where_1_contact_p==1 & ///
	(sec0_q1_contact_p==1  | sec0_q1_contact_p==2  ///
	| sec0_q1_contact_p==3  | sec0_q1_contact_p==4 ///
	| sec0_q1_contact_p==5)  & missing(migration_guinea)
*Did you leave Conakry? YES
replace migration_guinea=1 if where_11_contact_p==2 & ///
	(sec0_q1_contact_p==1  | sec0_q1_contact_p==2  ///
	| sec0_q1_contact_p==3  | sec0_q1_contact_p==4 ///
	| sec0_q1_contact_p==5) & missing(migration_guinea)
gen migration_guinea_2 = migration_guinea
...
esttab using ///
"migrationguinea_less6_fu2.tex", replace stats(cont N, label( "$2^{nd}$ Follow-up Cont. Mean" "N")) ///
coeflabels(1.treatment_status "Control" 2.treatment_status ///
"Risk Treatment" 3.treatment_status "Econ Treatment" ///
4.treatment_status "Double Treatment" 2.strata "Big school" ///
 _cons "Constant") se ///
 starlevels(\sym{+} 0.1 \sym{*} 0.05 \sym{**} 0.01 \sym{***} 0.001) ///
nonumbers title(Migration from Guinea at $2^{nd}$ Follow-Up  (Only Contacts with Last Conv. $<$ 6 Months Ago) \label{migrationconakryless6fu2}) /// 
mtitles("\shortstack{(1) \\ Only \\ Interviewed \\ Subject  }" ///
	"\shortstack{(2) \\  Previous \\ and \\ Contacts  }" ///
	"\shortstack{(3) \\  Previous \\ and \\ Class.  }" ///
	"\shortstack{(4) \\  Previous \\ and \\ Admin.  }" ///
...
replace migration_guinea=1 if where_11_contact_sec==2  & ///
	...
	&  missing(migration_guinea)
*Did you leave Conakry? NO
replace migration_guinea=0 if where_11_contact_p==1 & ///
	(sec0_q1_contact_p==1  | sec0_q1_contact_p==2  ///
	| sec0_q1_contact_p==3  | sec0_q1_contact_p==4 ) ///
	 & missing(migration_guinea)
*Did you leave Conakry? YES
...
esttab using ///
"migrationguinea_less1_fu2.tex", replace stats(cont N, label( "$2^{nd}$ Follow-up Cont. Mean" "N")) ///
coeflabels(1.treatment_status "Control" 2.treatment_status ///
"Risk Treatment" 3.treatment_status "Econ Treatment" ///
4.treatment_status "Double Treatment" 2.strata "Big school" ///
 _cons "Constant") se ///
 starlevels(\sym{+} 0.1 \sym{*} 0.05 \sym{**} 0.01 \sym{***} 0.001) ///
nonumbers title(Migration from Guinea at $2^{nd}$ Follow-Up (Only Contacts with Last Conv. $<$ 1 Month Ago)  \label{migrationconakryless1fu2}) /// 
mtitles("\shortstack{(1) \\ Only \\ Interviewed \\ Subject  }" ///
	"\shortstack{(2) \\  Previous \\ and \\ Contacts  }" ///
	"\shortstack{(3) \\  Previous \\ and \\ Class.  }" ///
	"\shortstack{(4) \\  Previous \\ and \\ Admin.  }" ///
...
gen desire = sec2_q1
replace desire = sec2_q1_p if desire == .
replace desire =0 if desire == 2
replace desire = 1 if migration_guinea == 1

gen planning = 2 if desire == 0
replace planning = sec2_q4 if planning == .
replace planning = sec2_q4_p if planning == .
replace planning = 0 if planning == 2
replace planning = 1 if migration_guinea == 1


gen prepare = 2 if planning == 0
replace prepare = sec2_q7 if prepare == .
replace prepare = sec2_q7_p if prepare == .
replace prepare = 0 if prepare == 2
replace prepare = 1 if migration_guinea == 1
...
graph save Graph ${main}/Draft/figures/migrationoutcomes_fu2.gph, replace
graph export ${main}/Draft/figures/migrationoutcomes_fu2.png, replace

restore


esttab using ///
"migrationintentions_fu2.tex", replace stats(cont N, label( "$2^{nd}$ Follow-up Cont. Mean" "N")) ///
coeflabels(1.treatment_status "Control" 2.treatment_status ///
"Risk Treatment" 3.treatment_status "Econ Treatment" ///
4.treatment_status "Double Treatment" 2.strata "Big school" ///
 _cons "Constant") se ///
  starlevels(\sym{+} 0.1 \sym{*} 0.05 \sym{**} 0.01 \sym{***} 0.001) ///
nonumbers title(Migration intentions at $2^{nd}$ Follow-Up \label{migrationintentions}) /// 
...
foreach route_u in $routes_list {
	...
	*est clear
	...
	replace trtmnt = treated_dummy`t'
		...
		foreach dep of global `route'_outcomes {  
				char define `dep'[_spec] reg f2.`dep' \`treatvar' `other_treatvar'  i.strata,  clus(sid)
	}   
	...
	***********************************PCA**************************************
	...
	foreach y in $`route'_outcomes {
		...
		gen y = `y'
		qui reg f2.y $controls, cluster(schoolid_str)
	...
	esttab $main_reg using ///
		...
		y "Basel. outc." _cons "Constant")  ///
		 starlevels(\sym{+} 0.1 \sym{*} 0.05 \sym{**} 0.01 \sym{***} 0.001) ///
		nonumbers title(Risk perceptions for route through `route_u' at $2^{nd}$ Follow-Up \label{`route_u'outcomes}) /// 
...
esttab  $main_reg using ///
	...
	4.treatment_status "Double Treat." 2.strata "Big school" ///
	y "Basel. outc." _cons "Constant")  ///
	nonumbers title(Perceptions about economic outcomes at $2^{nd}$ Follow-Up \label{economicoutcomes}) /// 
...
esttab $appendix_reg using ///
	...
	starlevels(\sym{+} 0.1 \sym{*} 0.05 \sym{**} 0.01 \sym{***} 0.001) ///
	nonumbers title(Impacts on Kling at $2^{nd}$ Follow-Up (2007) Indexes \label{appendixoutcomes}) /// 
...
reg f2.migclass i.treatment_status i.strata, cluster(schoolid)
reg f2.migclass i.treatment_status i.strata migclass, cluster(schoolid)
