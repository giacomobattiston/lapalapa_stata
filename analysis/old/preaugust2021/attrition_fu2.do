...
la var fath_educ1 "Father completed primary school or Preschool"
la var fath_educ2 "Father completed secondary school"
la var fath_educ3 "Father completed higher education (University, etc.)"
la var fath_educ4 "Father completed don't know"
la var fath_educ5 "Father completed no education"

la var moth_educ1 "Mother completed primary school or Preschool"
la var moth_educ2 "Mother completed secondary school"
la var moth_educ3 "Mother completed higher education (University, etc.)"
la var moth_educ4 "Mother completed don't know"
la var moth_educ5 "Mother completed no education"


*variable for the balance
global bc_var_demo = " female age moth_school fath_school wealth_index " ///
				+ "   durables50 grade2 grade3 fath_educ1 fath_educ2 fath_educ3 fath_educ4 fath_educ5 " ///
				+ " moth_educ1 moth_educ2 moth_educ3 moth_educ4 moth_educ5 " ///
				+ " brother_no_win sister_no_win " ///
				+ " contacts_winsor mig_classmates tele_daily tele_weekless inter_daily inter_weekless " 
				
global bc_var_outcomes = "desire planning prepare " ///
...
global bc_var_school = " strata_n2 fees50 repeaters transfers ratio_female_second ratio_female_lycee rstudteach_win rstudadmin_win rstudclass_win ratio_tmale ratio_tmaster " ///
				+ " schoolinf_index  "
...
****************BALANCE TABLE: INDIVIDUAL CHARACTERISTICS***********************
...
balancetable (mean if treatment_status==1)  ///
	...
	$bc_var_demo using "bal_nost_ind.xls",  ///
...
********BALANCE TABLE: INDIVIDUAL CHARACTERISTICS (WITH ATTENDANCE)**************

balancetable (mean if treatment_status==1)  ///
	(diff treatment_status_2 if treatment_status == 1 | treatment_status == 2) ///
	(diff treatment_status_3 if ( treatment_status == 1 | treatment_status == 3)) ///
	(diff treatment_status_4 if (treatment_status == 1 | treatment_status == 4)) ///
	$bc_var_demo using "bal_nost_onlyatt_ind.xls",  ///
	 nonumbers ctitles("Control Mean" "Risk-Control" "Econ-Control" ///
	"Double-Control") replace varlabels vce(cluster schoolid) 
...
****************BALANCE TABLE: OUTCOMES***********************

balancetable (mean if treatment_status==1)  ///
	(diff treatment_status_2 if treatment_status == 1 | treatment_status == 2) ///
	(diff treatment_status_3 if ( treatment_status == 1 | treatment_status == 3)) ///
	(diff treatment_status_4 if (treatment_status == 1 | treatment_status == 4)) ///
	$bc_var_outcomes using "bal_nost_out.xls",  ///
	 nonumbers ctitles("Control Mean" "Risk-Control" "Econ-Control" ///
	"Double-Control") replace varlabels vce(cluster schoolid) 
...
********BALANCE TABLE: OUTCOMES (WITH ATTENDANCE)**************

balancetable (mean if treatment_status==1)  ///
	(diff treatment_status_2 if treatment_status == 1 | treatment_status == 2) ///
	(diff treatment_status_3 if ( treatment_status == 1 | treatment_status == 3)) ///
	(diff treatment_status_4 if (treatment_status == 1 | treatment_status == 4)) ///
	$bc_var_outcomes using "bal_nost_onlyatt_out.xls",  ///
	 nonumbers ctitles("Control Mean" "Risk-Control" "Econ-Control" ///
	"Double-Control") replace varlabels vce(cluster schoolid) 
...
balancetable (mean if treatment_status==1)  ///
	...
	(diff treatment_status_3 if ( treatment_status == 1 | treatment_status == 3)) ///
	(diff treatment_status_4 if (treatment_status == 1 | treatment_status == 4)) ///
	$bc_var_school using "bal_nost_school.xls",  ///
	 nonumbers ctitles("Control Mean" "Risk-Control" "Econ-Control" ///
	"Double-Control") replace varlabels vce(cluster schoolid) 
...
global controls = " school_size female i.classe_baseline moth_school fath_school wealth_index wealth_index durables50 fees50sch contacts_winsor mig_classmates"
*/
...
*local cont = `r(mean)'
outreg2 using attrition_1.xls, replace label  dec(3) ct(" ") nonotes addtext(Baseline Mean Contr., `cont', H0: T1 = T2 [p-value], `pre', H0: T1 = T3 [p-value], `prd', H0: T3 = T4 [p-value], `ped') nocons keep(2.treatment_status 3.treatment_status 4.treatment_status)
...
local cont = string(`r(mean)', "%9.3f")  
*local cont = `r(mean)'  
outreg2 using attrition_1.xls, append label ct(" ") dec(3) nonotes addtext(Baseline Mean Contr., `cont', H0: T1 = T2 [p-value], `pre', H0: T1 = T3 [p-value], `prd', H0: T3 = T4 [p-value], `ped') nocons keep(2.treatment_status 3.treatment_status 4.treatment_status)
...
**************************ATTRITION (School, Phone, Contact, SSS, Unstructured), INDIVIDUAL DATA***************************
*without interactions
...
local cont = string(`r(mean)', "%9.3f")  
*local cont = `r(mean)' 
outreg2 using attrition_1.xls, append label ct(" ") dec(3) nonotes addtext(Baseline Mean Contr., `cont', H0: T1 = T2 (p-value), `pre', H0: T1 = T2 (p-value), `prd', H0: T1 = T2 (p-value), `ped') nocons keep(2.treatment_status 3.treatment_status 4.treatment_status)
*/
