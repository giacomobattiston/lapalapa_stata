...
nonumbers title(Migration Intentions at \( 1^{st} \) Follow-up \label{migrationintentions}) /// 
...
foreach route_u in $routes_list {
	...
	*/
	...
	esttab $main_reg using ///
		...
		nonumbers title(Risk perceptions for route through `route_u' at \( 1^{st} \) Follow-up \label{`route_u'outcomes}) /// 
...
reg f.desire i.treatment_status##i.mig_class0 desire i.strata , cluster(schoolid)
est sto reg1
reg f.planning i.treatment_status##i.mig_class0 planning i.strata , cluster(schoolid)
est sto reg2
reg f.prepare i.treatment_status##i.mig_class0 prepare i.strata , cluster(schoolid)
est sto reg3
...
reg f.italy_index i.treatment_status##i.mig_class0 italy_index i.strata , cluster(schoolid)
est sto reg1
reg f.spain_index i.treatment_status##i.mig_class0 spain_index i.strata , cluster(schoolid)
est sto reg2
reg f.economic_index i.treatment_status##i.mig_class0 economic_index i.strata , cluster(schoolid)
est sto reg3
...
reg f.italy_kling_poscost i.treatment_status##i.mig_class0 italy_kling_poscost i.strata , cluster(schoolid)
est sto reg1
reg f.italy_kling_negcost i.treatment_status##i.mig_class0 italy_kling_negcost i.strata , cluster(schoolid)
est sto reg2
reg f.spain_kling_poscost i.treatment_status##i.mig_class0 spain_kling_poscost i.strata , cluster(schoolid)
est sto reg3
reg f.spain_kling_negcost i.treatment_status##i.mig_class0 spain_kling_negcost i.strata , cluster(schoolid)
est sto reg4
reg f.economic_kling i.treatment_status##i.mig_class0 economic_kling i.strata , cluster(schoolid)
est sto reg5
...
reg f.desire i.treatment_status##i.sec2_q11 desire i.strata , cluster(schoolid)
est sto reg1
reg f.planning i.treatment_status##i.sec2_q11 planning i.strata , cluster(schoolid)
est sto reg2
reg f.prepare i.treatment_status##i.sec2_q11 prepare i.strata , cluster(schoolid)
est sto reg3
...
reg f.italy_index i.treatment_status##i.sec2_q11 italy_index i.strata , cluster(schoolid)
est sto reg1
reg f.spain_index i.treatment_status##i.sec2_q11 spain_index i.strata , cluster(schoolid)
est sto reg2
reg f.economic_index i.treatment_status##i.sec2_q11 economic_index i.strata , cluster(schoolid)
est sto reg3
...
reg f.italy_kling_poscost i.treatment_status##i.sec2_q11 italy_kling_poscost i.strata , cluster(schoolid)
est sto reg1
reg f.italy_kling_negcost i.treatment_status##i.sec2_q11 italy_kling_negcost i.strata , cluster(schoolid)
est sto reg2
reg f.spain_kling_poscost i.treatment_status##i.sec2_q11 spain_kling_poscost i.strata , cluster(schoolid)
est sto reg3
reg f.spain_kling_negcost i.treatment_status##i.sec2_q11 spain_kling_negcost i.strata , cluster(schoolid)
est sto reg4
reg f.economic_kling i.treatment_status##i.sec2_q11 economic_kling i.strata , cluster(schoolid)
est sto reg5
*/
...
esttab  $main_reg using ///
	...
	y "Basel. outc." _cons "Constant")  ///
	starlevels(\sym{*} 0.1 \sym{**} 0.05 \sym{***} 0.01) ///
	nonumbers title(Perceptions about economic outcomes  at \( 1^{st} \) Follow-up \label{economicoutcomes}) /// 
...
esttab $appendix_reg using ///
	...
	starlevels(\sym{*} 0.1 \sym{**} 0.05 \sym{***} 0.01) ///
	nonumbers title(Impacts on Kling (2007) Indexes  at \( 1^{st} \) Follow-up \label{appendixoutcomes}) /// 
...
esttab $italy_other_risk_reg using ///
	...
	nobaselevels ///
postfoot("\hline\hline \multicolumn{9}{p{12cm}}{\footnotesize Errors are clustered at the school level. P-values are denoted as follows: \sym{+} \(p<0.1\), \sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\).  } \\ \end{tabular} \end{table}")
