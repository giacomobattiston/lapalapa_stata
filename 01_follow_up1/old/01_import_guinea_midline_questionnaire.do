...
Date Last Modified: NMay 15, 2018
...
local corrfile1 "$main/Data/correction_file/unfinished_questionnaire_1.xlsx" // Les questionnaires non-finalisés 1
local corrfile2 "$main/Data/correction_file/unfinished_questionnaire_2.xlsx" //Les questionnaires non-finalisés 2
local corrfile3 "$main/Data/correction_file/unfinished_questionnaire_3.xlsx" //Les questionnaires non-finalisés 3
local corrfile4 "$main/Data/correction_file/error_lycee_name.xlsx" //Les questionnaires avec de mauvais nom de lycées
...
replace `dtvarlist'2="2" if `dtvarlist'2=="fÃ©vr."
